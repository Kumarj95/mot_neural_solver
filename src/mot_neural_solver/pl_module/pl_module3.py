...
from mot_neural_solver.models.mpn3 import MOTMPNet
...
class MOTNeuralSolver3(pl.LightningModule):
    """
    ...
    def track_all_seqs(self, output_files_dir, dataset, use_gt = False, verbose = False, save_res=False, save_path=None, edge_idx_path=None, edge_attr_path=None):
        tracker = MPNTracker(dataset=dataset,
                             ...
                             edge_idx_pth=edge_idx_path,
                             edge_attr_path=edge_attr_path)
